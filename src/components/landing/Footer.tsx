      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-2.5">
            <h4 className="font-semibold text-stone-900 text-xs uppercase tracking-wider">Platform</h4>
            <ul className="space-y-2 font-medium">
              <li><button onClick={onOpenGetStarted} className="text-teal-800 font-semibold hover:text-teal-900 transition-colors cursor-pointer">Get Started (Free Trial)</button></li>
              <li><button onClick={onExploreDemo} className="hover:text-stone-900 transition-colors cursor-pointer">Member Dashboard</button></li>
              <li><a href="#compatibility" className="hover:text-stone-900 transition-colors">Wearable Hardware Sync</a></li>
              <li><a href="#science" className="hover:text-stone-900 transition-colors">Autonomic & HRV Science</a></li>
              <li><a href="#community" className="hover:text-stone-900 transition-colors">Cohort Challenges & Classes</a></li>
            </ul>
          </div>

          {/* Hardware Ecosystems */}
          <div className="space-y-2.5">
            <h4 className="font-semibold text-stone-900 text-xs uppercase tracking-wider">Integrations</h4>
          ...
          {/* Compliance & Privacy */}
          <div className="space-y-2.5">
            <h4 className="font-semibold text-stone-900 text-xs uppercase tracking-wider">Trust & Legal</h4>
            <ul className="space-y-2 text-stone-600">
              <li><span className="text-stone-700">Privacy Policy (GDPR / CCPA)</span></li>
              <li><span className="text-stone-700">Terms of Service</span></li>
              <li><span className="text-stone-700">Biometric Data Protection Notice</span></li>
              <li><span className="text-stone-700">Scientific Advisory Disclosure</span></li>
            </ul>
          </div>
